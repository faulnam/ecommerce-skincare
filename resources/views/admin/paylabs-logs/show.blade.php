...
@section('title', 'Detail Log Paylabs')
@section('page-title', 'Detail Log Paylabs')

@section('breadcrumb')
    <a href="{{ route('admin.dashboard') }}">Dashboard</a> /
    <a href="{{ route('admin.paylabs-logs.index') }}">Log Paylabs</a> /
    ...
    <div class="col-md-10 mx-auto">
        <div class="card bg-white shadow-sm rounded-3 border-0">
            <div class="card-header bg-transparent border-bottom d-flex justify-content-between align-items-center p-4">
                <h5 class="mb-0 fw-bold"><i class="fas fa-money-bill-wave text-primary me-2"></i>Detail Paylabs Log</h5>
            ...
            <div class="card-body p-4">
                ...
                <div class="mt-4 text-end">
                    <a href="{{ route('admin.paylabs-logs.index') }}" class="btn btn-secondary">
