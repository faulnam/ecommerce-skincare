...
@section('title', 'Log Paylabs')
@section('page-title', 'Log Paylabs')
...
<div class="card bg-white shadow-sm rounded-3 border-0">
    <div class="card-body p-4">
        ...
        <!-- Filter & Search -->
        <form method="GET" action="{{ route('admin.paylabs-logs.index') }}" class="row g-3 mb-4">
            <div class="col-md-6">
            ...
            <div class="col-md-3">
                <a href="{{ route('admin.paylabs-logs.index') }}" class="btn btn-outline-secondary w-100">Reset</a>
            </div>
        </form>
                ...
                <tbody>
                    @forelse ($logs as $log)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.paylabs-logs.show', $log) }}" class="btn btn-sm btn-outline-primary">
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="text-center py-5 text-muted">
                                <i class="fas fa-money-bill-wave fs-1 d-block mb-3"></i>
                                Belum ada log Paylabs yang tercatat.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
