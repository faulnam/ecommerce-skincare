...
@section('content')
    <div class="card">
        <div class="card-header">
            <i class="fas fa-edit me-2"></i>Edit Insight: {{ $insight->title }}
        </div>
        <div class="card-body">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="excerpt" class="form-control @error('excerpt') is-invalid @enderror"
                                rows="2">{{ old('excerpt', $insight->excerpt) }}</textarea>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="author" class="form-control @error('author') is-invalid @enderror"
                                value="{{ old('author', $insight->author) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="status" id="statusSelect"
                                ...
                                <option value="draft" {{ old('status', $insight->status) == 'draft' ? 'selected' : '' }}>Draft
                                </option>
                        ...
                        <div class="mb-3 d-none" id="publishDateContainer">
                            ...
                            <input type="datetime-local" name="published_at"
                                ...
                                value="{{ old('published_at', $insight->published_at ? \Carbon\Carbon::parse($insight->published_at)->format('Y-m-d\TH:i') : '') }}">
                            @error('published_at') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Gambar Utama</label>
                            <div class="mb-2 {{ $insight->image ? '' : 'd-none' }}" id="imagePreviewContainer">
                                <img id="imagePreview" src="{{ $insight->image ? $insight->image_url : '#' }}" alt="Preview"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="alt_image"
                                ...
                                value="{{ old('alt_image', $insight->alt_image) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="meta_description" id="metaDescriptionInput"
                        ...
                        <div class="d-grid mt-4">
                            <button type="submit" class="btn btn-primary"><i class="fas fa-save me-2"></i>Perbarui
                                Insight</button>
