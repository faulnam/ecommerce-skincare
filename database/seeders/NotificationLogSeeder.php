    ...
    public function run(): void
    {
        ...
        $logs = [
            [
                ...
                'message' => 'Halo! Berikut adalah kode OTP Anda untuk menyelesaikan pendaftaran di Hijab: 123456. Kode ini berlaku selama 5 menit.',
                'status' => 'sent',
            ...
            [
                ...
                'message' => 'Terima kasih telah berbelanja di Hijab! Pesanan Anda dengan ID #ORD-99211 sedang menunggu pembayaran. Silakan selesaikan pembayaran Anda sebelum batas waktu habis.',
                'status' => 'sent',
            ...
            [
                ...
                'message' => 'Pesanan Anda telah berhasil dikirim dan diselesaikan. Semoga Anda puas dengan produk Hijab dari kami. Jangan lupa untuk memberikan ulasan!',
                'status' => 'sent',
            ...
            [
                ...
                'message' => 'Pesan Anda telah kami terima. Tim support Hijab akan segera membalas pesan Anda dalam 1x24 jam kerja.',
                'status' => 'sent',
                'created_at' => now(),
                'updated_at' => now(),
            ],
